 ...
 * AESCipher
 *
 * This class implements the AES algorithm which produces 10 additional round keys.
 */
public class AESCipher {
   ...
   * aesSBox
   *
   * This function takes an input character by using the Rijndael S-box which provides a substitution character.
   *
   * Parameters:
   *   inHex uses the Rijndael S-box to transform the characters
   *   x is used as an index on Rijndael S-box
   *
   */
   ...
   * aesRcon
   *
   * This function provides a constant from Rcon and takes input integer
   *
   * Parameters:
